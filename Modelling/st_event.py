...
normalized_folder1 = os.path.join('..', 'normalized/event/train')
normalized_folder2 = os.path.join('..', 'normalized/event/test')

data = pd.read_csv(os.path.join(normalized_folder1, 'sn_new_event_nor.csv'))

# Load test datasets
test_datasets = {
    'c': pd.read_csv(os.path.join(normalized_folder2, 'sn_event_c_nor.csv')),
    'm': pd.read_csv(os.path.join(normalized_folder2, 'sn_event_m_nor.csv')),
    'i': pd.read_csv(os.path.join(normalized_folder2, 'sn_event_i_nor.csv')),
    'n': pd.read_csv(os.path.join(normalized_folder2, 'sn_event_n_nor.csv')),
    'lp': pd.read_csv(os.path.join(normalized_folder2, 'lp_event_nor.csv')),
    'rea': pd.read_csv(os.path.join(normalized_folder2, 'rea_event_nor.csv')),
    'ytb': pd.read_csv(os.path.join(normalized_folder2, 'ytb_event_nor.csv')),
    'mg': pd.read_csv(os.path.join(normalized_folder2, 'mg_event_nor.csv'))
}

# Feature selection
features = ['cache-misses', 'context-switches', 'page-faults', 'minor-faults', 'major-faults', 'branch-misses', 
            'instructions', 'cpu-cycles', 'cache-references', 'msr/tsc/', 'cpu-clock', 'ex_ret_instr', 
